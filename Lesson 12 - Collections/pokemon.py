...
# User Pokemon
# TODO Create a multidimension list that holds 4 pokemon attacks and their different damage
...
# TODO Create a while loop that continues until current health <= 0
    # TODO Ask the user which attack they's like to use (list all 4 options, numbered); save input
    # TODO Use try except to ensure the user has input a number; if they didn't tell them so and then use 'continue'
...
# TODO: Give your wild pokemon an attack value as well, then allow it to attack the user back each turn
