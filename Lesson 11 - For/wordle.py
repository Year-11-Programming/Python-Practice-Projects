...
# TODO Create a while loop that runs if play is true
    ...
    # TODO Create a variable count and set it to 0
    # TODO Create a while loop that goes while count is less than 5
        # TODO Check if the 'count' letter of user_input is the same as the 'count' letter of the word and if it is tell them they got that letter correct

        # TODO Otherwise check if the 'count' letter of user_input is in the word and if it is, tell them that letter is in the wrong position
...
# ==========================================================
# EXTENSION
# Instead of telling the user one by one about their letters, put each correct letter or _ for a wrong letter into a list. 
# Then finally print the list (you can use "".join(list_name) to merge them into a string if you like)

# ==========================================================
# EXPERT
# Following on from the extension, add colour to the letters instead (Don't use _ for incorrect anymore). Green for correct, orange for wrong place, red for incorrect.
